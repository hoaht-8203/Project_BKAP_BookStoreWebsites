...
<body>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <table class="table table-hover" id="table2">
                                            ...
                                            <tbody>
                                            <c:forEach items="${formatList}" var="bd">
                                                <tr>
                                                    <td>
                                                        <span class="badge bg-primary">${bd.formats.name}</span>
                                                    </td>
                                                    <td>
                                                        <span class="badge bg-primary">
                                                            <fmt:formatNumber value="${bd.price}" type="currency"/>
                                                        </span>
                                                    </td>
                                                    <td>
                                                        <span class="badge bg-primary">${bd.quantitySold}</span>
                                                    </td>
                                                    <td>
                                                        <span class="badge bg-primary">${bd.quantityStock}</span>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                            </tbody>
    ...
    <script>
        ...
        let optionPercentStockSold  = {
            series: [${percentSold}, ${percentStock}],
            labels: ['Quantity Sold', 'Quantity Stock'],
        ...
        var chartPercentStockSold = new ApexCharts(document.getElementById('percent-stock-sold'), optionPercentStockSold)
        chartPercentStockSold.render()
    </script>
</body>
</html>
