                    ...
                    <div class="col-12 col-md-6 order-md-2 order-first">
                        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="index.html">List Format</a></li>
                        ...
                        <section class="section">
                            <div class="card">
                                <div class="card-header">
                                    <h4>Detail Format (${formatById.name})</h4>
                                </div>
                                <div class="card-body">
                        ...
                        <section class="section">
                            <div class="card">
                                <div class="card-header" style="display: flex;">
                                    <h4 class="col-6">Format Name: ${formatById.name}</h4>
                                    <div class="col-6 text-end">
                                        <a class="btn btn-primary" href="initAddNewFormat">Back</a>
                                    </div>
                                </div>
