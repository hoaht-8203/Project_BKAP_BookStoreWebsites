                    ...
                    <div class="col-12 col-md-6 order-md-2 order-first">
                        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Add Book To Sale</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="col-md-8 col-12">
                        <section class="section">
                            <div class="card">
                                ...
                                <div class="card-header" style="display: flex;">
                                    <h4 class="col-6">Choose Book To Add</h4>
                                    <div class="col-6 text-end">
                                        <a class="btn btn-primary" href="detailSale?id=${sale.id}">Cancel</a>
                                    </div>
                                </div>
                                <div class="card-body row">
                                    <table class="table table-hover" id="table1">
                                        <thead>
                                            ...
                                            <tbody>
                                                <c:forEach items="${booksSaleNull}" var="b">
                                                    <tr>
                                                        <td>${b.id}</td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <a data-bs-toggle="tooltip" data-bs-placement="right" class="btn btn-warning rounded-pill" title="ADD" href="addNewBookSale?saleId=${sale.id}&bookId=${b.id}"
                                                               onclick="return confirm('Are you sure to add this book?')">
