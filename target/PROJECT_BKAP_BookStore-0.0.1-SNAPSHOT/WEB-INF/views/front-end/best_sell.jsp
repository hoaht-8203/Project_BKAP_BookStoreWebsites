	...
	<section class="section-margin calc-60px">
		<div class="container">
			<div class="row justify-content-between section-intro pb-60px">
				<h2 class="col-9">
					Best sell <span class="section-intro__style">Books</span>
				</h2>
				<a class="col-3 right_buttom button button-header" href="viewAllBestSell">View all (${countBestSell})</a>
			</div>
			<div class="row d-flex align-items-start">
				<c:forEach items="${listBookBestSell}" var="bd">
					<div class="col-3">
						<div class="card">
